...
from tracker.models import (
    UserProfile, Category, Account, Transaction, Budget, 
    BudgetPeriod, Rule, Attachment, Import
)
from .serializers import (
    CategorySerializer, AccountSerializer, TransactionSerializer,
    BudgetSerializer, BudgetPeriodSerializer, RuleSerializer,
    AttachmentSerializer, ImportSerializer, UserProfileSerializer,
    DashboardSerializer, TransactionBulkSerializer
)
    ...
    def bulk_create(self, request):
        ...
        if serializer.is_valid():
            ...
            for transaction_data in transactions_data:
                ...
                if skip_duplicates:
                    fingerprint = self.generate_fingerprint(transaction_data, request.user)
...
class ImportViewSet(viewsets.ModelViewSet):
    ...
    def retry(self, request, pk=None):
        ...
        return Response({'error': 'Can only retry failed imports'}, status=status.HTTP_400_BAD_REQUEST)
