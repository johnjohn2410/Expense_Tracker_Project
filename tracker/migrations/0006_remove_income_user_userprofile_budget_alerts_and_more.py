...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "date"], name="tracker_tra_user_id_d71426_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["user", "category"], name="tracker_tra_user_id_ea3525_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["user", "account"], name="tracker_tra_user_id_d6e265_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["fingerprint"], name="tracker_tra_fingerp_269da8_idx"
            ),
        ),
        migrations.CreateModel(
            name="Expense",
